...
*/
	...
	for(ip=0;ip<3;ip++){
	   ...
	   for(iLogE=0;iLogE<dimension;iLogE++){
	       ...
	       integralFlux[0][iLogE] +=  cascadeFlux.getDFEmgCascadeDLogE(logE)*solidAngle;
	   }
	   ...
	   for(iLogE=0;iLogE<dimension;iLogE++){
	       logE = InteractionsBase.getLogEnergyProducedMinimum() + 
		   Particle.getDeltaLogEnergy( )*(double )iLogE;
	       integralFlux[1][iLogE] +=  cascadeFlux.getDFHadronCascadeDLogE(logE)*solidAngle;
	   }
	   ...
	   for(iLogE=0;iLogE<dimension;iLogE++){
	       logE = InteractionsBase.getLogEnergyProducedMinimum() + 
		   Particle.getDeltaLogEnergy( )*(double )iLogE;
	       integralFlux[2][iLogE] +=  cascadeFlux.getDFTotalCascadeDLogE(logE)*solidAngle;
	   }
	...
	System.out.println("mssg I_emg(100GeV) = " + integral_emg + " [cm^-2! sec^-1!]");
	...
	System.out.println("mssg I_had(100GeV) = " + integral_hadron + " [cm^-2! sec^-1!]");
	...
	System.out.println("mssg I(100GeV) = " + integral + " [cm^-2! sec^-1!]");
