...
the detector volume after propagating in the earth is apriori given
...
public class EventMonoEnergyFlux {
    ...
    */
    public EventMonoEnergyFlux(DataInputStream eventIn) throws IOException {
