...
public class DrawPropagatingNeutrinoFlux2 {
   ...
   public static void main(String[] args) throws IOException {
       ...
       in.close( );
        ...
        System.out.println("tity log (dF/dLogE [cm^-2 sec^-1 sr^-1])");
        System.out.println("scal 5.0 12.0 -25.0 -16.0");
	...
	for(iLogE=0;iLogE<dimension;iLogE++){
	    ...
	    double logEFlux;
	    if(Flux > 0.0){
		logEFlux = Math.log(Flux/ln10)/ln10;
	    }else{
		logEFlux = -30.0;
	    }
