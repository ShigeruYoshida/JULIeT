...
/**
    This class defines IceCube-ARA local coordinate system.
...
public class IceCubeARACoordinate extends EarthLocalCoordinate {
	...
	9284.46ft */
    public static double elevation = 1.4e5; 
    ...
    public static double origin_x = -ara_easting;
    public static double origin_y = ara_northing;
