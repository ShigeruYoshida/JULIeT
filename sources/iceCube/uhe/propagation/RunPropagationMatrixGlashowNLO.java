...
public class RunPropagationMatrixGlashowNLO extends RunPropagationMatrix{
    ...
    */
    public RunPropagationMatrixGlashowNLO(double nadirAngle,
	...
	if((0<intSwitch && intSwitch <512) && (0<decaySwitch && decaySwitch <512)){
	    ...
	    propMtx = new PropagationMatrixGlashowNLO(nuE,nuMu,nuTau,e,mu,tau,pi,
