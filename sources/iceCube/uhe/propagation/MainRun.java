...
public class MainRun {
	...
	RunPropagationMatrix run = null;
        ...
        if(args.length!=5 && args.length!=6){
            System.out.println(
"Usage: MainRunPropagation NadirAngle[deg] (trajectoryLength[cm]) intSwitch decaySwitch upDownFlag file-name");
	    System.exit(0);
	...
	if(upDownFlag ==1){
	    ...
	    mediumNumber = 1; //Rock
	    run =
		new RunPropagationMatrix(nadirAngle,intSwitch,decaySwitch,mediumNumber);
