...
*/
public class NeutrinoNeutralZeusPDF extends Interactions implements Function{
    private static final long serialVersionUID = 2525094295794974370L;	
	private String neutrinoFile = "iceCube/uhe/interactions/nuNC_ZeusPDF.dat";
	...
	It also reads the pre-calculated y/E * dsigma/dy
        from the data file. */
	public NeutrinoNeutralZeusPDF(Particle p,ParticlePoint s) throws IOException{
		super(p,s,3);
    ...
    */
	...
	public String interactionName(){
		String channel = "Neutrino-Nuclen Neutral Interaction ";
