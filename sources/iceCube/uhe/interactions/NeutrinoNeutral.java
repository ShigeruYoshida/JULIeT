...
public class NeutrinoNeutral extends Interactions implements Function {
    ...
    private String  neutrinoFile = "iceCube/uhe/interactions/nunch5.dat";
	...
	It also reads the pre-calculated y/E * dsigma/dy
        from the data file. */
    public NeutrinoNeutral(Particle p, ParticlePoint s) throws IOException {
	super(p, s, 3);
    ...
    */
	...
	String channel = "Neutrino-Nuclen Neutraled Interaction ";
