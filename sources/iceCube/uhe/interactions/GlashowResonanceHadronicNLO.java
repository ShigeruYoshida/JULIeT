...
*/
public class  GlashowResonanceHadronicNLO extends GlashowResonanceLeptonicNLO implements Function{


    /** Ration Gamma_hadron/Gamma_lepton  from PDG 2023*/
    protected final double ratioOfDecayWidth = 6.207;

    public GlashowResonanceHadronicNLO(ParticlePoint s){
  super(s, 3); 
